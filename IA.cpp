...
void InitializeFlight() {
    f->insertFlight("6E-6234", "Delhi", "Mumbai", "12:30 PM", 200);
    f->insertFlight("6E-6012", "Kolkata", "Lucknow", "9:00 AM", 250);
    f->insertFlight("6E-1209", "Banglore", "Ahemdabad", "4:00 AM", 215);
    f->insertFlight("SG-2534", "Hyderabad", "Jaipur", "1:30 PM", 150);
}
